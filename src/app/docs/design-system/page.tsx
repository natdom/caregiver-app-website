...
export const metadata: Metadata = {
  title: 'Design System',
  description: 'Design tokens, components, and patterns used in pero.',
  robots: {
    index: false,
    follow: false,
  },
        ...
        <div className="mx-auto max-w-6xl space-y-12">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-xl leading-8 text-neutral-600 dark:text-neutral-200">
              Components, tokens, and patterns for pero
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-base text-neutral-600 dark:text-neutral-200 mb-4">
                  This is regular body text. pero is designed to be warm, approachable, and professional. 
